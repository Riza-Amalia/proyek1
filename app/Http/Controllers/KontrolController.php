...
class KontrolController extends Controller
{
    ...
    {
        return view('kontrol.index', ['kontrol' => Kontrol::index()]);
    }
    ...
    {
        return view('kontrol.edit', ['kontrol' => $kontrol]);
    }
